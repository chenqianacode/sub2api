export default {
  ...
  usageOverview: {
    title: '用量总览',
    description: '查看全站用户用量与当前上游账号用量汇总',
    adminHint: '管理员可查看完整的用户与账号标识，用于运营统计和成本核对。',
    userPrivacyHint: '普通用户可查看全站汇总用量，用户与账号身份信息已匿名处理。',
    startDate: '开始日期',
    endDate: '结束日期',
    apply: '应用',
    usersTab: '用户用量',
    ...
    todayCost: '今日 {cost}',
    actualCost: '用户实际扣费',
    userBilledCost: '按用户倍率计算',
    upstreamAccountCost: '按上游账号倍率计算',
    inputShort: '输入',
    outputShort: '输出',
    cacheShort: '缓存',
    today: '今日'
  ...
  dashboard: {
    ...
    noUsageOverview: '暂无用户用量',
    noUsageOverviewHint: '用户产生用量后，这里会显示今日、本周、本月和累计统计。',
    accountUsageWindow: '用量窗口',
    clickLoadUsageWindow: '尚未加载',
    loadUsageWindow: '加载',
    noUsageWindowLoaded: '尚未加载',
    noAccountUsageWindow: '暂无可用用量窗口',
    loadUsageWindowFailed: '加载用量窗口失败',
    recentUsage: '最近使用',
    last7Days: '近 7 天',
