export default {
  ...
  usageOverview: {
    ...
    description: 'View aggregate usage for all users and current upstream accounts',
    adminHint: 'Administrators can view full user and account identities for operations and cost reconciliation.',
    userPrivacyHint: 'Regular users can view aggregate platform usage. User and account identities are anonymized.',
    startDate: 'Start Date',
    endDate: 'End Date',
    apply: 'Apply',
    usersTab: 'User Usage',
    accountsTab: 'Account Usage',
    user: 'User',
    account: 'Account',
    requests: 'Requests',
    tokens: 'Tokens',
    ...
    status: 'Status',
    totalRequests: 'Total Requests',
    todayRequests: '{count} requests today',
    totalTokens: 'Total Tokens',
    ...
    todayCost: 'Today {cost}',
    actualCost: 'User Billed Cost',
    userBilledCost: 'Calculated with user rate multipliers',
    upstreamAccountCost: 'Calculated with upstream account rate multipliers',
    inputShort: 'In',
    outputShort: 'Out',
    cacheShort: 'Cache',
    today: 'Today'
  ...
  dashboard: {
    ...
    output: 'Output',
    cache: 'Cache',
    usageOverview: 'User Usage',
    currentUsage: 'Current Usage',
    today: 'Today',
    week: 'Week',
    month: 'Month',
    requestCount: '{count} requests',
    noUsageOverview: 'No user usage',
    noUsageOverviewHint: 'Today, week, month, and total usage will appear after users generate usage.',
    accountUsageWindow: 'Usage Window',
    clickLoadUsageWindow: 'Not loaded',
    loadUsageWindow: 'Load',
    noUsageWindowLoaded: 'Not loaded',
    noAccountUsageWindow: 'No usage window available',
    loadUsageWindowFailed: 'Failed to load usage window',
